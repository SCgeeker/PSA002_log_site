...
- Navigate the tracking logs and enter the language page you are testing. There is the link to 003 survey page on the top. The sequential analysis plot for a lab will be avaialbe when a lab has collected 50 participants.
...
- **N**: Maximal sample size this lab will recruite
- **Seq_N**: Sample Size to initilize the sequential analysis after 50.
